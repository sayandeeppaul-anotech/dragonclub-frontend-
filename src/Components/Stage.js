            ...
            <div className="container">
                <div className="stagebox">
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"white"}}>Subham</div>
                    ...
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"white"}}>Shivam</div>
                    ...
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"white"}}>Subrato</div>
                ...
                <div className="runnerup">
                    <div className="fourfive">
                        ...
                        <div className="details">
                            <span className="runner-up-name" style={{color:"white"}}>Winner 4</span>
                        </div>

                        <div className="win">
                        <span>Recieve </span><br/>
                            <span>₹50000</span>
                    ...
                    <div className="fourfive"> <div className="position">
                        ...
                        <div className="details">
                            <span className="runner-up-name" style={{color:"white"}}>Winner 5</span>
                        </div>
